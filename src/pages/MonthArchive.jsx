      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        {filteredData.length > 0 && (
          <div className="text-center mt-12">
            <button className="bg-white text-gray-700 border border-gray-300 hover:border-gray-400 px-8 py-3 rounded-lg font-medium transition-all duration-200 hover:shadow-lg">
              Load More Archives
            </button>
          </div>
        )}
